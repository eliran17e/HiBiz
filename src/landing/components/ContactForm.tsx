...
// Front-end only for now — submission just flips to the success state.
export function ContactForm() {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center rounded-2xl border border-emerald-500/25 bg-emerald-500/[0.06] px-6 py-10 text-center">
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mt-4">
        <p className="mb-2 text-xs font-medium text-zinc-500">{t("landing.contact.industry")}</p>
